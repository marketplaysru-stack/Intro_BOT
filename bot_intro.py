...
# ---------- СПИСОК НАВИГАТОРОВ (только наши) ----------
GROUPS = [
    {
        "name": "AI Навигатор",
        "link": "https://vk.com/ai_navigator",          # замените на реальную ссылку
    ...
    },
    {
        ...
        "link": "https://vk.com/stroy_navigator",       # замените на реальную ссылку
    ...
    },
    {
        ...
        "link": "https://vk.com/roditelskiy_navigator", # замените на реальную ссылку
    ...
    },
    {
        ...
        "link": "https://vk.com/music_navigator",       # замените на реальную ссылку, если есть
...
# ---------- ЗАПУСК ----------
def main():
    logger.info("🚀 Интро-бот запущен (только навигаторы)")
